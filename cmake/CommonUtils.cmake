...
function (create_test)
    ...
    add_executable("Test${CREATE_TEST_TEST_NAME}" ${CREATE_TEST_SOURCES})
    target_link_libraries("Test${CREATE_TEST_TEST_NAME}" GTest::gtest GTest::gtest_main ${CREATE_TEST_LIBRARIES})
    target_include_directories("Test${CREATE_TEST_TEST_NAME}" PUBLIC "${CMAKE_SOURCE_DIR}/include")
    add_test(NAME "${CREATE_TEST_TEST_NAME}Test" COMMAND "Test${CREATE_TEST_TEST_NAME}" "--verbose")
endfunction()
