...
std::vector<std::byte> Serialization::Serialize32BitUnsignedInt(std::uint32_t number)
{
...
std::uint32_t Serialization::Deserialize32BitUnsignedInt(const std::span<std::byte>& bytes)
{
